...
const Home: React.FC = () => {
    ...
    const getPriceBln = async() => {
       
        const muzo = await axios.get('https://api.pancakeswap.info/api/v2/tokens/0xE90334c19c798C3A18d81b8cd16594247D5B19dd')
        console.log(muzo.data.data.price)
        setPrice(muzo.data.data.price)
    }
    useEffect(()=>{
        getPriceBln()
    },[])
